...
class FreeResultController extends Controller
{
    /**
    ...
    public function index(){   
        ...
        $par_3=0;
        $par_4=0;
            // echo'<pre>';print_r($count_qstn_first->question_no);echo'</pre>';exit();
        ...
        return view('frontend.free-report',compact('possibility','appreciation','truth','harmony','freedom','devotion','passion','partnership','relationship_lookup_text','user_details','shadow','shadow_lookup_text'));
    ...
    public function relationship_lookuptext($possibility,$appreciation,$truth,$harmony,$freedom,$devotion,$passion,$partnership,$relationship_arr){
        ...
        $datasession = session()->all();
        $formdata = DB::table('formdata')->where('id',$datasession['formid'])->first();
    ...
    public function shadow_calculation($a){
       ...
       if (array_key_exists("collapse_third",$arr_collapse1)){
        ...
        // echo'<pre>';print_r($dependence_third);echo'</pre>';exit();
