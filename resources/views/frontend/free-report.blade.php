            ...
            <div class="page-content">
                <div class="sitemax-width">
                    <div class="text-center mb-5">
                        ...
                        <p class="mb-1">Result Summary for <strong>{{$user_details['firstname']}} {{$user_details['lastname']}}</strong> in {{$user_details['type']}} to <strong>{{$user_details['relation']}}</strong></p>
                                                ...
                                                <table class="dot-slider">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><small class="">Appreciation</small></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><small class="">Devotion</small></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><small class="">Harmony</small></td>
                                                        </tr>
                                                        <tr>
                                                            <td><small class="">Passion</small></td>
                                                            <td>
                                                                <div class="dot-progress">
                                        ...
                                        <div class="card zoomed-version animated">
                                            ...
                                            <div class="card-body">
                                                <table class="dot-slider">
                                                    <tbody>
                                                        <tr>
                                                            <td><small class="">Initiating</small></td>
                                                            <td>
                                                                <div class="dot-progress">
                                                                    <!-- <span class="background_primary" style="width: 20%"></span> -->
                                                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><small class="">Spontaneity</small></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <table class="dot-slider">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><small class="">Defense</small></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><small class="">Collapse</small></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><small class="">Anxious</small></td>
                                                    </tr>
                                                    <tr>
                                                        <td><small class="">Addiction</small></td>
                                                        <td>
                                                            <div class="dot-progress">
                                                                <!-- <span class="background_primary" style="width: 20%"></span> -->
                                                            </div>
                            ...
                            <div class="text-center pt-3 mb-5">
                                <div class="transform-graphic">
                                    <div class="dynamic-graphic animated">
                                        ...
                                        <div class="last-row">
                                            <figure class="highlighted-purple-big">
                                                <img src="{{ asset('images/Evolving Love Energy Icon - Appreciation Defense (Grey Scale).png')}}" alt="Evolving Love Energy Icon - Appreciation _ Defense">
