            ...
            <div class="page-content">
                <div class="sitemax-width">
                    <div class="page-breadcrum mb-6">
                        <a href="/biggest-doubts-and-fears" class="btn btn-secondary prev">
                        ...
                        <a href="/conflict-profile" class="btn btn-secondary next">
                            Next <i class="fas fa-caret-right"></i>
                        </a>
                    </div>

                    <div class="text-center mb-5">
                        <h2 class="color_black mb-4">MOST TRIGGERED BY</h2>
                    ...
                    <p>{{$primary_trigger->primary_trigger}}</p>
                    <h3>Secondary Trigger</h3>
                    <p>{{$secondary_trigger->secondary_trigger}}</p>
                    ...
                    $check_page = DB::table('progress_steps')->where('formid',$datasession['formid'])->where('page21','!=',NULL)->first();
                    @endphp
                    @if($check_page)
                    ...
                    <form method="post" action="/markcomplete">
                        @csrf
                        <input type="hidden" name="page" value="page21">
