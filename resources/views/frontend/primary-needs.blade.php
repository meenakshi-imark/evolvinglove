            ...
            <div class="page-content">
                <div class="sitemax-width">
                    <div class="page-breadcrum mb-6">
                        <a href="/sensitivities" class="btn btn-secondary prev">
                        ...
                        <a href="/biggest-doubts-and-fears" class="btn btn-secondary next">
                    ...
                    <div class="text-center mb-5">
                        <h2 class="color_black mb-4">PRIMARY NEEDS</h2>
                    ...
                    <h3>Primary Need</h3>
                    <p>{{$primary_needs->primary_needs}}</p>
                    <h3>Secondary Need</h3>
                    <p>{{$secondary_needs->secondary_needs}}</p>
                    ...
                    $check_page = DB::table('progress_steps')->where('formid',$datasession['formid'])->where('page19','!=',NULL)->first();
                    @endphp
                    @if($check_page)
                    ...
                    <form method="post" action="/markcomplete">
                        @csrf
                        <input type="hidden" name="page" value="page19">
