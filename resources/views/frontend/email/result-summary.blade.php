            ...
            <div class="page-content">
                <div class="sitemax-width">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <p>Submitted on <span class="color_black">{{date("l");}}, {{date('F d, Y');}} at 3:17: PM</span></p>
                    </div>
                                    ...
                                    <div class="h-100 d-flex align-items-center">
                                        <table class="dot-slider">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dot-progress">
                                                        <span class="background_green" style="width: {{$shadow_percentage['harmony_truth']}}%"></span>
                                                    </div>
                                                </td>
                                                @if($harmony>$truth)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dot-progress">
                                                        <span class="background_blue" style="width: {{$shadow_percentage['devotion_freedom']}}%"></span>
                                                    </div>
                                                </td>
                                                @if($freedom<$devotion)
                                    ...
                                    <div class="h-100 d-flex align-items-center">
                                        <table class="dot-slider">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dot-progress">
                                                        <span class="background_green" style="width: {{$per_shadow['control_collapse']}}%"></span>
                                                    </div>
                                                </td>
                                                @if($shadow['control']<$shadow['collapse'])
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dot-progress">
                                                        <span class="background_blue" style="width: {{$per_shadow['avoidance_anxious']}}%"></span>
                                                    </div>
                                                </td>
                                                @if($shadow['avoidance']<$shadow['anxious'])
                    ...
                    <div class="background-box my-6" style="background-image: url('{{ asset('images/Evolving Love Sidebar & Practices Background - Red.png')}}');">
                    ...
                    <div class="text-center my-6">
                        <a href="javascript:void(0)" class="btn btn-primary br h-55">Mark Complete</a>
                    </div>
